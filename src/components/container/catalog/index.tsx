                  ...
                  >
                    <div className="flex gap-5">
                      <div className="relative md:min-w-40">
                        ...
                        />
                        <Dialog>
                          <DialogTrigger className=" bg-white/10 border-white/20 backdrop-blur-sm border-1 overflow-hidden p-1 absolute rounded-xl bottom-0.5 w-[calc(100%_-_8px)] shadow-small ml-1 z-10 font-semibold ">
                            <span className="text-center">show detail</span>
                          </DialogTrigger>
                          <DialogContent className="w-full bg-stone-100/30 dark:bg-gray-800/30 backdrop-filter backdrop-blur-sm rounded-3xl">
                            <DialogHeader>
